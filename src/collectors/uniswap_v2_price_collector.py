...
class UniswapV2PriceCollector(UniswapPriceCollector):
    ...
    def __init__(
            self,
            wss_rpc: str,
            uniswap_v2_factory_address_str: str,
            network,
    ...
    def set_event_signature(self):
        pair_created_event_abi = (next(item for item in self.uniswap_factory_abi
    ...
    def get_address_from_event(self, event: AttributeDict) -> str | None:
        ...
        logs = self.uniswap_factory.events.PairCreated().process_receipt(receipt)
